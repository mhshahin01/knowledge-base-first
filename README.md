...
| [`tutorials/004-oauth-2-part-1.md`](system-design/identity-access-management-iam/tutorials/004-oauth-2-part-1.md) | OAuth 2.0: the delegation problem it solves, why 1.0 and 2.0 are different protocols, the four roles, the grant types and which are deprecated, a full authorization code with PKCE trace, scopes and consent. |
